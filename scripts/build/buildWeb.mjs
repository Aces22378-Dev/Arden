...
async function buildExtension(target, files) {
    const entries = {
        "dist/Arden.js": await readFile("dist/browser/extension.js"),
        "dist/Arden.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Arden.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Arden.user.js", cssRuntime);
});
